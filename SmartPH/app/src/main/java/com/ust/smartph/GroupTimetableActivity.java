 ...
 * @author ycfelix
 * <p>
 * Custom timetable home view, controller to the view of timetable for group
 */
public class GroupTimetableActivity extends AppCompatActivity {
    ...
    private final String PREF_MON_WED="group_monwed";
    private final String PREF_THR_SUN="group_thrsun";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        switchTimetable.setText("GROUP TIMETABLE \n SWITCH TO PERSONAL TIMETABLE ?");
    }
    ...
    void deletePrefs(View v){
        ...
        editor.remove("group_monwed");
        editor.remove("group_thrsun");
        editor.commit();
    }
