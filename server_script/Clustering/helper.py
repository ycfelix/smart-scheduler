...
def draw_scatterplot(x_data, x_label, y_data, y_label, minLat, maxLat, minLng, maxLng):
    fig = plt.figure(figsize=(8,8))
    ax = fig.add_subplot(111)

    plt.xlim(minLat, maxLat)
    plt.ylim(minLng, maxLng)
    ax.set_xlabel(x_label)
    ax.set_ylabel(y_label)
    ax.scatter(x_data, y_data, s=30)


def draw_clusters(biased_dataset, predictions, x_label, y_label, minLat, maxLat, minLng, maxLng, cmap='viridis'):
    fig = plt.figure(figsize=(8,8))
    ax = fig.add_subplot(111)
    plt.xlim(minLat, maxLat)
    plt.ylim(minLng, maxLng)
    ...
    plt.scatter(clustered[x_label], clustered[y_label], c=clustered['group'], s=20, cmap=cmap)
